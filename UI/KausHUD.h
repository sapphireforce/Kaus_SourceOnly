 ...
 */
UCLASS(Config = Game)
class KAUS_API AKausHUD : public AHUD
{
	GENERATED_BODY()
	
public:
	AKausHUD(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	TObjectPtr<UKausUILayerConfig> DefaultLayerConfig;
};
