...
#include "KausAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FKausAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UKausAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FKausAbilityTagRelationship> AbilityTagRelationships;
